...
int main(int argc, char *argv[]) {
  ...
  for (int j = 0; j < 5; j++) {
    ...
    float max_error = gemm_error_check_nn<half>(
        lanunch_hgemm_mma_m16n8k16_swizzle_nn<2, 2048>, M, N, K);
  ...
  for (int j = 0; j < test_num; j++) {
    ...
    for (int k = 0; k < outer_repeat; k++) {
      double this_sec =
          perf_gemm<half>(lanunch_hgemm_mma_m16n8k16_swizzle_nn<2, 2048>, M, N,
                          K, inner_repeat, warmup);
...
void hgemm_mma_m16n8k16_mma2x4_warp4x4x2_stages_dsmem_swizzle(
  ...
  if (swizzle) {
    ...
    switch (stages) {
    case 2: // ~35KB
      LAUNCH_16816_STAGE_MMA2x4_WARP4x4x2_DSMEM_SWIZZLE_KERNEL(2,
                                                               swizzle_stride);
      break;
    case 3: // ~51KB
      LAUNCH_16816_STAGE_MMA2x4_WARP4x4x2_DSMEM_SWIZZLE_KERNEL(3,
                                                               swizzle_stride);
      break;
    case 4: // ~68KB
      LAUNCH_16816_STAGE_MMA2x4_WARP4x4x2_DSMEM_SWIZZLE_KERNEL(4,
                                                               swizzle_stride);
      break;
    case 5: // ~85KB
      LAUNCH_16816_STAGE_MMA2x4_WARP4x4x2_DSMEM_SWIZZLE_KERNEL(5,
                                                               swizzle_stride);
      break;
    default:
      LAUNCH_16816_STAGE_MMA2x4_WARP4x4x2_DSMEM_SWIZZLE_KERNEL(2,
